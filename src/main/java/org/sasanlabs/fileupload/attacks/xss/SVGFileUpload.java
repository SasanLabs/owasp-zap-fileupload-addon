...
public class SVGFileUpload implements AttackVector {
    ...
    private static final List<FileParameter> FILE_PARAMETERS_EXTENDED =
            Arrays.asList(
                    ...
                    new FileParameter("Svg", FileExtensionOperation.PREFIX_ORIGINAL_EXTENSION),
                    new FileParameter(
                            "SVG",
                            "image/svg+xml",
                            FileExtensionOperation.PREFIX_ORIGINAL_EXTENSION),
                    ...
                    new FileParameter(
                            ...
                            "image/svg+xml",
                            FileExtensionOperation.PREFIX_ORIGINAL_EXTENSION),
                    new FileParameter("Svgz", FileExtensionOperation.PREFIX_ORIGINAL_EXTENSION),
                    new FileParameter(
                            "SVGZ",
                            "image/svg+xml",
                            FileExtensionOperation.PREFIX_ORIGINAL_EXTENSION),
                    new FileParameter("SVGZ", FileExtensionOperation.PREFIX_ORIGINAL_EXTENSION),
                    new FileParameter(
                            "Xml", "text/xml", FileExtensionOperation.PREFIX_ORIGINAL_EXTENSION),
                    new FileParameter("Xml", FileExtensionOperation.PREFIX_ORIGINAL_EXTENSION),
                    new FileParameter(
                            "XML", "text/xml", FileExtensionOperation.PREFIX_ORIGINAL_EXTENSION),
                    new FileParameter("XML", FileExtensionOperation.PREFIX_ORIGINAL_EXTENSION));
    ...
    private static final List<FileParameter> FILE_PARAMETERS_DEFAULT =
            Arrays.asList(
                    new FileParameter("svg"),
                    // if html works then html file upload will only work
